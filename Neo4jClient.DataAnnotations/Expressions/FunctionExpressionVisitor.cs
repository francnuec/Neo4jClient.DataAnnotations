    ...
    public partial class FunctionExpressionVisitor : ExpressionVisitor
    {
        public static Dictionary<MemberInfo, Func<FunctionHandlerContext, Func<Expression>>>
            DefaultMemberInfoHandlers = new Dictionary<MemberInfo, Func<FunctionHandlerContext, Func<Expression>>>()
            {
                ...
                { Utils.Utilities.GetMethodInfo(() => CypherFunctions.Distinct<object>(null)), FunctionHandlers.Distinct },
                ...
                { Utils.Utilities.GetMethodInfo(() => Cypher.Functions.CypherExtensionFunctions.None<object>(null, (f) => true)),
                ...
                { Utils.Utilities.GetMethodInfo(() => Cypher.Functions.CypherExtensionFunctions.Single<object>(null, (f) => true)),
                ...
                { Utils.Utilities.GetMethodInfo(() => CypherFunctions.Rand()), (c) => FunctionHandlers.FuncsMethod(c, "Rand", "rand") },
                ...
                //logarithmic
                { Utils.Utilities.GetMethodInfo(() => CypherFunctions.E(0.0)), (c) => FunctionHandlers.FuncsMethod(c, "E", "e") },
                ...
                { Utils.Utilities.GetMethodInfo(() => CypherFunctions.Cot(0.0)), (c) => FunctionHandlers.FuncsMethod(c, "Cot", "cot") },
                { Utils.Utilities.GetMethodInfo(() => CypherFunctions.Degrees(0.0)), (c) => FunctionHandlers.FuncsMethod(c, "Degrees", "degrees") },
                { Utils.Utilities.GetMethodInfo(() => CypherFunctions.Haversin(0.0)), (c) => FunctionHandlers.FuncsMethod(c, "Haversin", "haversin") },
                { Utils.Utilities.GetMethodInfo(() => CypherFunctions.PI(0.0)), (c) => FunctionHandlers.FuncsMethod(c, "PI", "pi") },
                { Utils.Utilities.GetMethodInfo(() => CypherFunctions.Radians(0.0)), (c) => FunctionHandlers.FuncsMethod(c, "Radians", "radians") },
