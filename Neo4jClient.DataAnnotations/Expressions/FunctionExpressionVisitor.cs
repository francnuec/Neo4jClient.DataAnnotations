...
namespace Neo4jClient.DataAnnotations.Expressions
{
    public partial class FunctionExpressionVisitor : ExpressionVisitor
    {
        public static Dictionary<MemberInfo, Func<FunctionHandlerContext, Func<Expression>>>
            ...
            {
                { Utils.Utilities.GetMethodInfo(() => Vars.Get(null)), FunctionHandlers.GetVariable },
                { Defaults.CypherObjectIndexerInfo, FunctionHandlers.CypherObjectIndexer },
                { Utils.Utilities.GetMethodInfo(() => Enumerable.ElementAt<object>(null, 0)), FunctionHandlers.ElementAt },
                ...
                { Utils.Utilities.GetMethodInfo(() => (null as ICypherResultItem).Id()), (c) => FunctionHandlers.ICypherResultItemMethod(c, "Id", "id") },
                { Utils.Utilities.GetMethodInfo(() => (null as ICypherResultItem).CollectAs<object>()), (c) => FunctionHandlers.ICypherResultItemMethod(c, "CollectAs", "collect") },
                ...
                { Utils.Utilities.GetMethodInfo(() => (null as ICypherResultItem).Count()), (c) => FunctionHandlers.ICypherResultItemMethod(c, "Count", "count") },
                ...
                { Utils.Utilities.GetMethodInfo(() => (null as ICypherResultItem).Head()), (c) => FunctionHandlers.ICypherResultItemMethod(c, "Head", "head") },
                { Utils.Utilities.GetMethodInfo(() => (null as ICypherResultItem).Labels()), (c) => FunctionHandlers.ICypherResultItemMethod(c, "Labels", "labels") },
                { Utils.Utilities.GetMethodInfo(() => (null as ICypherResultItem).Last()), (c) => FunctionHandlers.ICypherResultItemMethod(c, "Last", "last") },
                { Utils.Utilities.GetMethodInfo(() => (null as ICypherResultItem).Length()), (c) => FunctionHandlers.ICypherResultItemMethod(c, "Length", "length") },
                { Utils.Utilities.GetMethodInfo(() => (null as ICypherResultItem).Type()), (c) => FunctionHandlers.ICypherResultItemMethod(c, "Type", "type") },
                #endregion
                ...
                { Utils.Utilities.GetMethodInfo(() => "".ToLower()), (c) => FunctionHandlers.StringMethod(c, "ToLower", "toLower") },
                { Utils.Utilities.GetMethodInfo(() => "".ToUpper()), (c) => FunctionHandlers.StringMethod(c, "ToUpper", "toUpper") },
                { Utils.Utilities.GetMethodInfo(() => "".Trim()), (c) => FunctionHandlers.StringMethod(c, "Trim", "trim") },
                { Utils.Utilities.GetMethodInfo(() => "".TrimStart()), (c) => FunctionHandlers.StringMethod(c, "TrimStart", "lTrim") },
                { Utils.Utilities.GetMethodInfo(() => "".TrimEnd()), (c) => FunctionHandlers.StringMethod(c, "TrimEnd", "rTrim") },
                ...
                { Utils.Utilities.GetMethodInfo(() => Funcs.Length<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "Length", "length") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Size<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "Size", "size") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Timestamp()),
                    (c) => FunctionHandlers.FuncsMethod(c, "Timestamp", "timestamp") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Id<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "Id", "id") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Type<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "Type", "type") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Properties<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "Properties", "properties") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.StartNode<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "StartNode", "startNode") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.EndNode<object>(null)),
                ...
                { Utils.Utilities.GetMethodInfo(() => Enumerable.Aggregate<object>(null, (a, v) => a)), FunctionHandlers.Aggregate },
                ...
                { Utils.Utilities.GetMethodInfo(() => Enumerable.Intersect<object>(null, null)), FunctionHandlers.Intersect },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Labels<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "Labels", "labels") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Keys<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "Keys", "keys") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Nodes<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "Nodes", "nodes") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Range(0, 0, 0)),
                    (c) => FunctionHandlers.FuncsMethod(c, "Range", "range") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Relationships<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "Relationships", "relationships") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Tail<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "Tail", "tail") },
                #endregion

                #region Aggregate Functions
                { Utils.Utilities.GetMethodInfo(() => Funcs.Average<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "Average", "avg") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Collect<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "Collect", "collect") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Count<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "Count", "count") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Max<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "Max", "max") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Min<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "Min", "min") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Sum<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "Sum", "sum") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Distinct<object>(null)), FunctionHandlers.Distinct },
                { Utils.Utilities.GetMethodInfo(() => Funcs.StandardDeviation<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "StandardDeviation", "stDev") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.StandardDeviationP<object>(null)),
                    (c) => FunctionHandlers.FuncsMethod(c, "StandardDeviationP", "stDevP") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.PercentileCont<object, double>(null, 0.0)),
                    (c) => FunctionHandlers.FuncsMethod(c, "PercentileCont", "percentileCont") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.PercentileDisc<object, double>(null, 0.0)),
                ...
                { Utils.Utilities.GetMethodInfo(() => Funcs.Exists<object>(null)),
                ...
                { Utils.Utilities.GetMethodInfo(() => Funcs.None<object>(null, (f) => true)),
                    (c) => FunctionHandlers.CypherListPredicate(c, "None", "none", Defaults.FuncsType) },
                { Utils.Utilities.GetMethodInfo(() => Cypher.Functions.ExtensionFuncs.None<object>(null, (f) => true)),
                    (c) => FunctionHandlers.CypherListPredicate(c, "None", "none", Defaults.ExtensionFuncsType) },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Single<object>(null, (f) => true)),
                    (c) => FunctionHandlers.CypherListPredicate(c, "Single", "single", Defaults.FuncsType) },
                { Utils.Utilities.GetMethodInfo(() => Cypher.Functions.ExtensionFuncs.Single<object>(null, (f) => true)),
                ...
                { Utils.Utilities.GetMethodInfo(() => Math.Ceiling(0.0)), (c) => FunctionHandlers.MathMethod(c, "Ceiling", "ceil") },
                { Utils.Utilities.GetMethodInfo(() => Math.Floor(0.0)), (c) => FunctionHandlers.MathMethod(c, "Floor", "floor") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Rand()), (c) => FunctionHandlers.FuncsMethod(c, "Rand", "rand") },
                { Utils.Utilities.GetMethodInfo(() => Math.Round(0.0)), (c) => FunctionHandlers.MathMethod(c, "Round", "round") },
                { Utils.Utilities.GetMethodInfo(() => Math.Sign(0.0)), (c) => FunctionHandlers.MathMethod(c, "Sign", "sign") },

                //logarithmic
                { Utils.Utilities.GetMethodInfo(() => Funcs.E(0.0)), (c) => FunctionHandlers.FuncsMethod(c, "E", "e") },
                ...
                { Utils.Utilities.GetMethodInfo(() => Math.Log10(0.0)), (c) => FunctionHandlers.MathMethod(c, "Log10", "log10") },
                { Utils.Utilities.GetMethodInfo(() => Math.Sqrt(0.0)), (c) => FunctionHandlers.MathMethod(c, "Sqrt", "sqrt") },

                //trigonometric
                { Utils.Utilities.GetMethodInfo(() => Math.Acos(0.0)), (c) => FunctionHandlers.MathMethod(c, "Acos", "acos") },
                { Utils.Utilities.GetMethodInfo(() => Math.Asin(0.0)), (c) => FunctionHandlers.MathMethod(c, "Asin", "asin") },
                { Utils.Utilities.GetMethodInfo(() => Math.Atan(0.0)), (c) => FunctionHandlers.MathMethod(c, "Atan", "atan") },
                { Utils.Utilities.GetMethodInfo(() => Math.Atan2(0.0, 0.0)), (c) => FunctionHandlers.MathMethod(c, "Atan2", "atan2") },
                { Utils.Utilities.GetMethodInfo(() => Math.Cos(0.0)), (c) => FunctionHandlers.MathMethod(c, "Cos", "cos") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Cot(0.0)), (c) => FunctionHandlers.FuncsMethod(c, "Cot", "cot") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Degrees(0.0)), (c) => FunctionHandlers.FuncsMethod(c, "Degrees", "degrees") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.HalfVersine(0.0)), (c) => FunctionHandlers.FuncsMethod(c, "HalfVersine", "haversin") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.PI(0.0)), (c) => FunctionHandlers.FuncsMethod(c, "PI", "pi") },
                { Utils.Utilities.GetMethodInfo(() => Funcs.Radians(0.0)), (c) => FunctionHandlers.FuncsMethod(c, "Radians", "radians") },
