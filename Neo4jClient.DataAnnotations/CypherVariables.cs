...
namespace Neo4jClient.DataAnnotations//.Cypher
{
    ...
    public sealed class CypherVariables
    {
        ...
        /// For example, CypherVariables.Get&lt;User&gt;("user").Name, is the exact same as CypherVariables.Get("user")["name"] ... assuming camel case serialization.
        /// </summary>
        ...
        /// For example, CypherVariables.Get&lt;User, string&gt;(user => user.Address.City).Name, is the exact same as CypherVariables.Get&lt;string&gt;("user.address_city")... assuming camel case serialization.
        /// </summary>
